...
async function encryptionExample() {
  ...
  console.log('   ✅ Sensitive user inserted:', sensitiveUser.document.name);
  console.log('   📄 Document ID:', sensitiveUser.id);
  ...
  console.log('   ✅ Found', usersWithAllergies.total, 'users with allergies:');
  ...
  console.log("   ✅ John's medications:", johnUpdated.medicalInfo.medications);
